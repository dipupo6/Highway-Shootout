...
public class ShareButton : MonoBehaviour {
	...
	public IEnumerator ShareTextInAnroid () {
		...
		var shareSubject = "Share the game";
		var shareMessage = "https://play.google.com/store/apps/details?id=com.ManradGames.SpaceCrusader";
		...
		if (!Application.isEditor) {
			...
			AndroidJavaObject chooser = 
				...
				("createChooser", intentObject, "Share the game");
